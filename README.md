## 프로젝트명 : movie-ticket (미래유망 고졸 인력 양성 사업 프로젝트)
...
<table border="1" style="width: 100%; border-collapse: collapse;">
    <tr style="text-align: center;">
        <td style="padding: 7.5px 15px;">백엔드 개발</td>
        <td style="padding: 7.5px 15px;">프론트엔드 개발</td>
        <td style="padding: 7.5px 15px;" colspan="3">PPT 제작</td>
    </tr>
    <tr style="text-align: center;">
        <td style="padding: 7.5px 15px;">강다윤</td>
        <td style="padding: 7.5px 15px;">양하민</td>
        <td style="padding: 7.5px 15px;">손양헌</td>
        <td style="padding: 7.5px 15px;">양하경</td>
        <td style="padding: 7.5px 15px;">진현민</td>
    </tr>
    <tr style="text-align: center;">
        <td style="padding: 7.5px 15px; width: 33%;">
        ...
        <td style="padding: 7.5px 15px; width: 33%;" colspan="3">
            화면설계서, 발표용 PPT 제작
        </td>
    </tr>
</table>
...
## 프로젝트 소개
2025년 **고용노동부 미래유망분야 고졸인력양성** 사업에서 진행한 CGV 영화 예매 키오스크 프로젝트입니다. 프론트엔드는 React 기반의 SPA 프레임워크로 구현되었고, 백엔드는 Spring Boot 기반 REST API 서버로 분리되어 있으며 각각 별도의 GitHub 레포지토리로 관리됩니다. 주요 기능은 영화 예매, 좌석 선택, 티켓 출력, 환불 등이 있습니다.
